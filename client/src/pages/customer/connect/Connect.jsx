// Connect.jsx - Trang liên hệ và kết nối với IconDenim
  ...
  const contactInfo = [
    {
      ...
      title: 'Địa chỉ',
      content: '484 Lê Văn Sỹ, Phường 14,\nQuận 3, TP. Hồ Chí Minh'
    },
    {
    ...
    <div className={`min-h-screen relative ${
      ...
      <div className="relative">
        ...
        <PageBanner 
          ...
          description="Theo dõi IconDenim trên các nền tảng mạng xã hội"
        />
