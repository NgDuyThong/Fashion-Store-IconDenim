...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: <FaEnvelope />,
      title: 'Email',
      content: 'support@icondenim.com\nicondenim3cg@gmail.com',
      action: 'mailto:support@icondenim.com'
    },
    {
      icon: <FaMapMarkerAlt />,
      title: 'Địa chỉ',
      content: '484 Lê Văn Sỹ, Phường 14, Quận 3,\nTP. Hồ Chí Minh',
      action: 'https://www.google.com/maps/place/484+L%C3%AA+V%C4%83n+S%E1%BB%B9,+Ph%C6%B0%E1%BB%9Dng+14,+Qu%E1%BA%ADn+3,+H%E1%BB%93+Ch%C3%AD+Minh'
    },
    {
      icon: <FaFacebookMessenger />,
      title: 'Facebook',
      content: 'fb.com/icondenim\nNhắn tin trực tiếp 24/7',
      action: 'https://m.me/icondenim'
    }
  ];
