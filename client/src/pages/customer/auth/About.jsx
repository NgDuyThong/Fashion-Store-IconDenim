...
const teamMembers = [
  {
    ...
    detailedInfo: {
      ...
      education: 'Đang theo học tại HUIT - Khoa CNTT',
      certifications: [
...
const schoolInfo = {
  ...
  shortName: 'HUIT',
  address: '140 Lê Trọng Tấn, Phường Tây Thạnh, Quận Tân Phú, TP. Hồ Chí Minh',
  website: 'https://ts.huit.edu.vn/',
  description: 'Được thành lập từ năm 1982, trải qua 4 lần nâng cấp, đổi tên, Trường Đại học Công Thương Thành phố Hồ Chí Minh là một trong những cơ sở giáo dục đại học định hướng ứng dụng dẫn đầu về đào tạo, nghiên cứu khoa học và chuyển giao công nghệ.',
  departments: [
    {
  ...
  educationLinks: [
    {
      ...
      logo: 'https://res.cloudinary.com/dm8a7wa1j/image/upload/v1760891953/84b4c5d0-0e97-4933-a368-960b3383b08a.png',
    ...
    },
    {
      ...
      logo: 'https://res.cloudinary.com/dm8a7wa1j/image/upload/v1760891968/44659cc8-1002-4318-b672-eb411bf9e84d.png', 
      website: 'https://www.uit.edu.vn/',
      description: 'Hợp tác đào tạo trong lĩnh vực công nghệ thông tin và chuyển tiếp sinh viên.'
    },
    {
      name: 'Đại học Công nghiệp (IUH)',
      logo: 'https://res.cloudinary.com/dm8a7wa1j/image/upload/v1760891877/023f3c6b-b608-4917-83e3-59097d29a594.png',
    ...
    },
    {
      ...
      logo: 'https://res.cloudinary.com/dm8a7wa1j/image/upload/v1760891987/5d53a980-1267-4542-a20a-ba0877dad865.png',
      website: 'https://www.falmi.org.vn/',
      description: 'Đối tác trong nghiên cứu và dự báo nhu cầu nhân lực CNTT.'
    },
    {
      name: 'Cánh Cam',
      logo: 'https://res.cloudinary.com/dm8a7wa1j/image/upload/v1760892012/62000ded-c86e-4cc3-8e86-9c9c084b2ce6.png',
    ...
    },
    {
      ...
      logo: 'https://res.cloudinary.com/dm8a7wa1j/image/upload/v1760892031/b24b94b3-dac2-47ed-8dd7-08e6d486c99b.png',
...
const customerReviews = [
  ...
  },
  {
    ...
    rating: 4,
    comment: 'Tôi rất hài lòng với trải nghiệm mua sắm tại IconDenim. Giá cả hợp lý, nhiều mẫu mã đẹp.',
    date: '10/03/2025',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Lần đầu mua hàng tại IconDenim nhưng rất ấn tượng. Chất lượng sản phẩm tốt, đúng như mô tả.',
    date: '01/02/2025',
  ...
  return (
    ...
    >
      <PageBanner 
        ...
        subtitle="Đội ngũ phát triển IconDenim"
      />
