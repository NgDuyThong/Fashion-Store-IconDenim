...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const adminRoles = ['admin', 'customer_manager', 'product_manager', 'order_manager', 'coupon_manager', 'promotion_manager', 'notification_manager'];
      ...
      if (adminRoles.includes(user.role)) {
        ...
        if (user.role === 'admin') {
          navigate('/admin/dashboard') // Admin chuyển đến dashboard
        } else if (user.role === 'customer_manager') {
          navigate('/admin/customers') // Nhân viên quản lý khách hàng
        } else if (user.role === 'product_manager') {
          navigate('/admin/products') // Nhân viên quản lý sản phẩm
        } else if (user.role === 'order_manager') {
          navigate('/admin/orders') // Nhân viên quản lý đơn hàng
        } else if (user.role === 'coupon_manager') {
          navigate('/admin/coupons') // Nhân viên quản lý mã giảm giá
        } else if (user.role === 'promotion_manager') {
          navigate('/admin/promotions') // Nhân viên quản lý khuyến mãi
        } else if (user.role === 'notification_manager') {
          navigate('/admin/notifications') // Nhân viên quản lý thông báo
        } else {
