                                ...
                                <div className={`container mx-auto px-4 py-8 ${isDarkMode ? 'dark bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            >
                                                <option key="normal" value="normal">📌 Khuyến mãi thường</option>
                                                <option key="flash-sale" value="flash-sale">⚡ Flash Sale</option>
                                            </select>
                                        </div>
                                        <div>
                                            <label className="block text-base font-medium mb-2">
            ...
            <div className={`p-6 rounded-xl shadow-sm mb-6 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                <div className="flex flex-wrap gap-4">
                    ...
                    >
                        ...
                        <option key="inactive" value="inactive">❌ Không hoạt động</option>
                        <option key="expired" value="expired">⏰ Đã hết hạn</option>
                    </select>
                    ...
                    >
                        <option key="all-type" value="all">🏷️ Tất cả loại</option>
                        <option key="normal-type" value="normal">📌 Khuyến mãi thường</option>
                        <option key="flash-sale-type" value="flash-sale">⚡ Flash Sale</option>
                    </select>
                    ...
                    >
                        <option key="createAt" value="createAt">📅 Ngày tạo</option>
                        <option key="endDate" value="endDate">⏰ Ngày kết thúc</option>
                        <option key="discountPercent" value="discountPercent">💰 Phần trăm giảm</option>
                    </select>
